...
<%@ taglib tagdir="/WEB-INF/tags" prefix="jb" %>

<c:url var="url" value="/viewstatus" /> <!-- NOT ERROR -->

<div class="row">

    <div class="col-md-8 col-md-offset-2">

        <jb:pagination url="${url}" page="${page}" size="10"/>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="edit-links pull-right">
                        <a href="${editLink}">edit</a> | <a onclick="return confirm('Really delete this Status update?');"
